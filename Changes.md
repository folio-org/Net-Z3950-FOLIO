...
* Support post-processing rules for MARC fields: diacritic removal and regular-expression substitution. Should give us all the flexibiliy we need for ZF-25.
* XXX TODO. Document the `postProcessing` part of the configuration file.
